...
public class CloudKey_LL
{
	...
	public CloudKey_LL(String _user_id, String _api_key) throws Exception
	{
		this(_user_id, _api_key, CLOUDKEY_API_URL, CLOUDKEY_CDN_URL, "");
	}

	public CloudKey_LL(String _user_id, String _api_key, String _base_url, String _cdn_url, String _proxy) throws Exception
	{
