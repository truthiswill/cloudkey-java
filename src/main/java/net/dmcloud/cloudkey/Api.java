        ...
        if (json_response.containsKey("error"))
        {
            ...
            switch (error_code)
            {
                ...
                case 300:
                    ...
                    break;
                case 400:
                    message = "AuthenticationErrorException";
                    break;
                case 410:
                    message = "RateLimitExceededException";
                    break;
                case 500:
                    message = "SerializerException";
                    break;
                ...
                case 610:
                    ...
                    break;
                case 620:
                    message = "InvalidMethodException";
                    break;
                case 630:
                    message = "InvalidParamException";
                    break;
                ...
                default:
                    message = "RPCException (error:" + json_response.pull("error.code").toString() + ")";
                    break;
            }
